setwd('C:\\Users\\13048\\Desktop\\Evolution\\Tasks\\Task_07')
library(phytools)
library(ape)
...
plot(AnolisTree,type="phylogram",use.edge.length = TRUE,
     ...
     show.node.label = TRUE,edge.color = NULL,edge.width = NULL,
     edge.lty = NULL,node.color = NULL,node.width = NULL,
     node.lty = NULL,font=3,cex = par("cex"),
     adj=NULL,srt=0,no.margin=FALSE,root.edge=FALSE,
     label.offset=0,underscore=FALSE,x.lim=NULL,
     y.lim = NULL,direction="rightwards",lab4ut = NULL,tip.color=par("black"),plot=TRUE,
...
Ancestors_withFossils<-fastAnc(AnolisTree,svl,anc.states=fossilNodes,CI=TRUE,vars=TRUE)
